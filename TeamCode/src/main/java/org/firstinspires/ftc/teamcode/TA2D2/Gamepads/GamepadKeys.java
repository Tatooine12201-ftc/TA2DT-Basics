...
public final class GamepadKeys {
    ...
    /**
     * Represents the standard face buttons, bumpers, D-pad inputs on a typical gamepad,
    ...
    public enum Button {
        ...
        DPAD_LEFT,
        DPAD_RIGHT,
        LEFT_STICK_BUTTON,  // Added LEFT_STICK_BUTTON
        RIGHT_STICK_BUTTON  // Added RIGHT_STICK_BUTTON
    }
